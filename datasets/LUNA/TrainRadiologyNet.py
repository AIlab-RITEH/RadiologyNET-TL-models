...
def task(lr, run_idx:int=None, backbone: str='res50', freeze:bool=False):
	...
	if backbone == 'vgg16':
		_training.transfer_weights("./VGG16.pth")
	elif backbone == 'res50':
		_training.transfer_weights("./ResNet50.pth")
	elif backbone == 'eff4':
		_training.transfer_weights("./EfficientNetB4.pth")
	else:
		raise NotImplementedError(f'Backbone {backbone} not implemented!')

	_training.freeze_unfreeze_model(freeze = freeze)
