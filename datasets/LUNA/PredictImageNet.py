...
for _backbone in [
    ...
    _lr = 0
    _info = "ImageNet_"+str(_lr)+"_"+_backbone
    ...
    modelConfig.augumentation_model = "LUNA_RGB"
    ...
    for _dir in _final_directories_list:
        ...
        for _model in _models_list:
            ...
            _training.model_predict_from_dl(val_dl, 'MiddleMan')
            
            # Work on statistics
            # Obtain files in MiddleMan
            _result_files = os.listdir('MiddleMan')
            ...
            for _image_file in _result_files:
                _true_mask_path = "MiddleMan"+"/"+_image_file+"/"+"GT_mask.png" 
                _predicted_mask_path = "MiddleMan"+"/"+_image_file+"/" + "PRED_mask.png"
