...
class datasetConfig:
    ...
    '''
    covid_imgs_png_home_path = None
    normal_imgs_png_home_path = None
    ...
    def __str__(self):
        ...
        _retval = ''
        _retval += ("######################################\n")
        _retval += (f'normal_imgs_png_home_path: {datasetConfig.normal_imgs_png_home_path}, '+
            f'covid_imgs_png_home_path: {datasetConfig.covid_imgs_png_home_path}, '+
...
class modelConfig:
    ...
    '''
    loss_name: name of the loss. Currently implemented: 'BinaryCrossEntropy
    '''
    loss_name = 'BCE'
    ...
    '''
    number_of_output_classes: number of output_classes required for model
    '''
